...
fn import_tflite_types<P: AsRef<Path>>(tflite: P) {
    ...
    let bindings = Builder::default()
        ...
        .whitelist_type("tflite::BufferT")
        .opaque_type("tflite::BufferT")
        .whitelist_type("tflite::TensorT")
        .opaque_type("tflite::TensorT")
        .whitelist_type("tflite::TensorType")
        .whitelist_type("tflite::QuantizationParametersT")
        .opaque_type("tflite::QuantizationParametersT")
        .whitelist_type("tflite::QuantizationDetailsUnion")
        .opaque_type("tflite::QuantizationDetailsUnion")
        .whitelist_type("tflite::QuantizationDetails")
        .whitelist_type("tflite::BuiltinOptions")
        .whitelist_type("tflite::BuiltinOptionsUnion")
        .whitelist_type("tflite::CustomOptionsFormat")
        .whitelist_type("tflite::OperatorT")
        .opaque_type("tflite::OperatorT")
        .whitelist_type("tflite::OperatorCodeT")
        .opaque_type("tflite::OperatorCodeT")
        .whitelist_type("tflite::ModelT")
        .opaque_type("tflite::ModelT")
        .whitelist_type("tflite::SubGraphT")
        .opaque_type("tflite::SubGraphT")
        .whitelist_type("flatbuffers::NativeTable")
        .opaque_type("flatbuffers::NativeTable")
        .whitelist_type("tflite::BuiltinOperator")
